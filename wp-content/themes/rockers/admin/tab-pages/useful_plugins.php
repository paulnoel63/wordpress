...
<div id="useful_plugins" class="rockers-tab-pane panel-close">
<div class="container-fluid">
	...
	<div class="col-md-4">
	<div class="rockers-tab-pane-half m-top-40">
		<h3><i class="dashicons dashicons-portfolio"></i><?php esc_html_e('Changelog','rockers'); ?></h3>
		<p><?php esc_html_e( 'Want to get the gist on the latest theme changes? Just consult our changelog below to get a taste of the recent fixes and features implemented.', 'rockers' ); ?></p>
		<p><a target="_self" href="#changelog" class="rockers-custom-class"><?php esc_html_e('Changelog','rockers'); ?></a></p>
	</div>
	</div>
